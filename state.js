...
// Function with no extra setup. If that ever fails (it has, in practice,
// on some deploys), this falls back to explicit credentials so the app
// keeps working instead of crashing — just add NETLIFY_AUTH_TOKEN as a
// site environment variable (Project configuration > Environment
// variables) and redeploy; NETLIFY_SITE_ID is already set automatically.
